...
function createProposalCard(proposal) {
  ...
  const logoThumb = proposal.uploadDriveUrls?.logo || '';
  const thumbHtml = logoThumb
    ? `<img src="${logoThumb}" class="proposal-thumbnail-img" alt="Logo">`
    : `<span class="proposal-thumbnail-placeholder">🖼️</span>`;

  card.innerHTML = `
    <div class="proposal-thumbnail">${thumbHtml}</div>
